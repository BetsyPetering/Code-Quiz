...
var secondsLeft = 0; //initialize secondsLeft as 0 - should be set to 75 as game begins
var currentSelection = new Boolean(true);  //set this to false so it will check the choice and 
currentSelection = false;                          //determine if answer is true or false - checkAnswer()
...
var wrongAnswer = checkAnswer(currentSelection) ////////////////////current dilemma
                                                                                            //how to return wrong answer into clock does return mean it goes back to where it's called?
                                                                                            //if so, what happens after it returns to the click?
function checkAnswer(currentSelection) {
    ...
    if (questions[current].choices[answerChoice] !== questions[current].answer) {
        sayCorrect = "Incorrect";//Flash "Correct" on screen for 1 second
        currentSelection = false;        
    }
    else {
        // TODO:  subtract 15 second from the clock
        sayCorrect = "Correct";//Flash "Incorrect" on screen for1 second    
